...
**Journalist & Trainer | OSINT & Data Exploration Enthusiast**

📍 Novi Sad • London • Frankfurt  
🏢 ICRC, ex-BBC  
🌐 [lazarcovs.com](https://lazarcovs.com)
...
- **[Publishing Date Finder](https://github.com/Popravljam/publishing-date-finder)** - Cross-browser extension using 8 detection methods to find publication dates on any webpage.

### Data & Exploration Tools
- **[Jugofilm.online](https://github.com/Popravljam/Jugofilm.online)** - Ex-Yugoslav film database with search, actor collaborations, and statistics. Built with Next.js & TypeScript.
- **[Telegram Bill Tracker](https://github.com/Popravljam/telegram-bill-tracker)** - Smart utility bill tracking with GPT-4 Vision AI analysis and Power BI integration.
- **[Serbian Word Explorer](https://github.com/Popravljam/serbian-word-explorer)** - Language exploration tool for Serbian linguistics.
